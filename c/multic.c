...
#  endif
//
//  Heres the deal,main.c Calls Boot without iniialzing Core 0 in command line
//  mode,MAke sure it defaults to 0 This is because we boot into core 0,-1 leads
//  to weird memory behavior. 21 Nrootconauto
//
